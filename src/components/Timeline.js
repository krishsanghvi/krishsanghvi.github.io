...
//Highschool, OSU, Snapon, FTC, Raas in the 614, 
  const items = [{
      ...
      },
    {
      ...
      cardSubtitle:"Majoring in Honors Computer Science and Engineering and Minoring in Mathematics",
      ...
      },
      {
        ...
        cardSubtitle: "Director of an intercollegiate Garba-Raas competition held in Columbus, Ohio at The Ohio State University.",
